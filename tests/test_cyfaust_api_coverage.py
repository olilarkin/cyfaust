...
class TestBoxAPI:
    ...
    def test_ui_box_elements(self):
        ...
        with box_context():
            ...
            vslider_box = box_vslider(
                "gain", box_real(0.5), box_real(0), box_real(1), box_real(0.01)
            )
...
class TestUtilityFunctions:
    ...
    def test_dsp_expansion(self):
        ...
        try:
            ...
            assert len(expanded_code) > len(dsp_code), (
                "Expanded code should be longer than original"
            )
        except Exception as e:
